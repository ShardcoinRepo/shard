...
QT_MOC_LITERAL(1, 23, 13), // "filterApplied"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "TransactionFilterProxy\0filterApplied\0"
    ""
};
...
void TransactionFilterProxy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TransactionFilterProxy::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TransactionFilterProxy::filterApplied)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void TransactionFilterProxy::filterApplied()
{
