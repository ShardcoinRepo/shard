...
#include "../src/qt/forms/exportpage.h"
...
QT_MOC_LITERAL(1, 11, 10), // "exportPage"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12), // "isNotDefault"
QT_MOC_LITERAL(4, 36, 3) // "ind"

    },
    "ExportPage\0exportPage\0\0isNotDefault\0"
    "ind"
};
...
void ExportPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ExportPage *_t = static_cast<ExportPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->exportPage(); break;
        case 1: _t->isNotDefault((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject ExportPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ExportPage.data,
      qt_meta_data_ExportPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExportPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExportPage.stringdata0))
        return static_cast<void*>(const_cast< ExportPage*>(this));
